...
Clip-Path erwartet einen "Basic Shape" als Wert. Hier kann man einen SVG-Path angeben. Mehr auf [MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/clip-path).
...
Dieses Beispiel wurde mit [Corner Inverter](https://corner-inverter.douiri.org/) gebaut.
